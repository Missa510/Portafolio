...
import { ProyectoItem } from "$_compon/en/Proyecto";
import { Loading } from "$_compon/en/ui/loading";
import { NotFound } from "$_compon/en/ui/notFound";
...
export default function ProyectosPage() {
    ...
    return (
        <Card props={{
            ...
            <h1 className="text-2xl lg:text-6xl text-center">Results</h1>
