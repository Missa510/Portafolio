        ...
        <section className="flex md:aspect-video overflow-hidden h-max w-full md:h-auto md:w-full md:flex-shrink-0 bg-no-repeat bg-cover bg-center rounded-lg shadow-md" style={{
            ...
            `.trim()} >
                ...
                <div className="grid gap-2 md:gap-6">
                    <p className="text-balance text-center text-lg md:text-2xl 2xl:text-3xl 2xl:text-center">{description}</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <a className="inline-flex items-center w-full gap-4 bg-stone-600 text-white px-4 py-2 rounded md:text-xl hover:bg-stone-900 focus:bg-stone-900 transition-all duration-200 ease-in-out" href={demo} target="_blank" rel="noopener noreferrer" aria-disabled>
                            <DemoIcon clases="text-white h-5 nd:h-6 w-auto" />
                            Ver el proyecto en acción
                        </a>
                        <a className="inline-flex items-center w-full gap-4 bg-slate-600 text-white px-4 py-2 rounded md:text-xl hover:bg-slate-900 focus:bg-slate-900 transition-all duration-200 ease-in-out" href={git} target="_blank" rel="noopener noreferrer">
